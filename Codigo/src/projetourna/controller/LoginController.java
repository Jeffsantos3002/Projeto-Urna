...
public class LoginController {
    ...
    public String ValidarUsuario(String name, String possword, String id){ 
         /*o metodo retorna situação do eleitor, nesse caso, se ele pode votar, se ja votou,
          se existe esse eleitor ou se preencheu os dados corretamente*/
        ...
        if(name.length() > 0 && possword.length() > 0 && id.length() == 0){ // vendo se os campos foram preenchidos
            ...
            if(encontrado){ // se for assinante irá verificar se ja votou ou não
            ...
            for (Critico critico : listaCriticos) { //lendo array de criticos
            ...
            if(encontrado){ // verificando se o critico ja votou
